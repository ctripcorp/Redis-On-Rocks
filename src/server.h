...
typedef struct __attribute__((aligned(CACHE_LINE_SIZE))) {
    ...
    redisAtomic ioThreadState thread_state;                    /* Running if true, main thread can send clients directly. */
...
struct redisServer {
    ...
    int config_io_threads_num;         /* Number of IO threads to use. */
    int io_threads_num;
    ioThreadScaleStatus io_threads_scale_status;
