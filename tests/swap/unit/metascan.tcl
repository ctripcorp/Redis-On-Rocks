start_server {tags "metascan"} {
    ...
    test {scan with unsuccessive cold cursor} {
        ...
        assert_equal [r scan 1 count 1] {257 a}
        # assert_equal [r scan 257 count 1] {513 b}
        # assert_equal [r scan 513 count 1] {0 c}
    ...
    test {scan switch from hot to cold rewinds cold cursor} {
        ...
        assert_equal [r scan 0 count 1] {3 {}}
        assert_equal [r scan 3 count 1] {259 a}
        assert_equal [r scan 0 count 1] {5 {}}
    ...
    test {scan} {
        r set key val
        assert_equal [r scan 0] {7 key}
        assert_equal [r scan 7] {0 {}}
        r swap.evict key
        wait_key_cold r key
        assert_equal [r scan 0] {9 {}}
        assert_equal [r scan 9] {0 key}
