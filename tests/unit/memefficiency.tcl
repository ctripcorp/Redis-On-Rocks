...
run_solo {defrag} {
    ...
    start_cluster 1 0 {tags {"defrag external:skip tsan:skip cluster" "memonly"} overrides {appendonly yes auto-aof-rewrite-percentage 0 save "" loglevel notice}} {
        test_active_defrag "cluster"
    }

    start_server {tags {"defrag external:skip tsan:skip standalone" "memonly"} overrides {appendonly yes auto-aof-rewrite-percentage 0 save "" loglevel notice}} {
