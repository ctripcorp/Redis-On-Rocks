...
if {$::swap == 1} {
    start_server [list overrides [list "dir" $server_path "dbfilename" "zset-ziplist.rdb" "swap-repl-rordb-sync" "no"]] {
...
exec cp -f tests/assets/zset-ziplist.rdb $server_path
if {$::swap == 1} {
    start_server [list overrides [list "dir" $server_path "dbfilename" "zset-ziplist.rdb" "zset-max-ziplist-entries" 1 "swap-repl-rordb-sync" "no"]] {
